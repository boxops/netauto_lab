...
from custom_jobs.custom_configuration.backup_configurations import DeviceBackup
from custom_jobs.custom_configuration.intended_configurations import DeviceIntent
from custom_jobs.custom_configuration.configuration_compliance import (
    DeviceCompliance,
)
