...
_DEFAULT_SEED: list[dict] = [
    ...
    dict(name="Interface restore — production → L3",
         ...
         min_prior_successes=0, autonomy_level="L3"),
    # Config compliance remediation — lab leaf auto-executes after 2 successes (L4)
    dict(
        name="ConfigDrift remediation — lab leaf → L4",
        alertname="ConfigDrift",
        fix_type="config_remediation",
        device_role="leaf",
        environment="lab",
        min_confidence="high",
        max_risk="low",
    ...
    # Config compliance remediation — lab spine stays supervised (L3) — wider blast radius
    dict(
        name="ConfigDrift remediation — lab spine → L3",
        alertname="ConfigDrift",
        fix_type="config_remediation",
        device_role="spine",
        environment="lab",
    ...
    # Config compliance remediation — any device in lab, zero successes yet → L3
    dict(
        name="ConfigDrift remediation — lab → L3",
        alertname="ConfigDrift",
        fix_type="config_remediation",
        device_role="",
        environment="lab",
    ...
    # Config compliance remediation — production always requires human approval (L2)
    dict(
        name="ConfigDrift remediation — production → L2",
        alertname="ConfigDrift",
        fix_type="config_remediation",
        device_role="",
