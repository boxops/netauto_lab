...
from engineering_agent.agent import EngineeringAgent, agent_status, task_store, rate_limiter, AGENT_NAME
...
runner = EngTaskRunner(agent, task_store, rate_limiter)
...
app = FastAPI(
    ...
    description="AI-powered network engineering assistant",
    version="2.0.0",
    lifespan=lifespan,
)
